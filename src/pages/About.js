    ...
    return (
      <Animated animationIn="fadeIn" animationOut="fadeOut" isVisible={true}>
        <div className="content" margin="auto">
              ...
              <p>I enjoy liaising with clients and uncovering solutions to improve infrastructure. As a full-stack software engineer and Scrum Leader (CSM), I enjoyed working with my team to design and build platforms with clean, modern, maintainable code to create efficient and effective user interfaces.</p>
              <br />
